...
echo "OK"
echo -n "Compiling..."
g++ -m32 -std=c++11 -fpermissive -fno-exceptions -fleading-underscore -fno-rtti -fno-builtin -enable-__cxa_atexit -nostdlib -nodefaultlibs -nostartfiles -lgpp -lgpl -lm -lpc -w -x c++ -c @files.txt
echo "OK"
echo -n "Linking..."
